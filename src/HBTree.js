...
(function _HBTree(global){
	...
	*/
	function HBTproperty()
	{
		...
		{
			return ["float","boolean","vec3", "string"];
		}} );
	...
	/* ADDED BY EVA */
	HBTproperty.prototype.onSerialize = function(o)
	{
	...
	global.HBTproperty = HBTproperty;
	/*
	...
	*/
	...
	{
		if(this.properties.value_to_compare.toString() == "") return false;
		var value = null;
	...
	global.BoolConditional = BoolConditional;
